<template>
	<view class="container">
		<u-navbar
			...
			title-color="#000000"
		>
			<view class="" slot="right"><image src="https://minio.nustantai.com/nustant-dp/nustant-rider-ui/images/user/c8.png" class="set-icon" mode="widthFix"></image></view>
		</u-navbar>
...
export default {
	...
	methods: {
		submit() {
			this.$u.api
				.token(this.tenantId, this.username, md5(this.password))
				.then(data => {
